...
import TabNavigation from "../features/home/components/TabNavigation";
import TopRatedGuideList from "../features/home/components/topRatedGuideList";
...
export default function Home(){
  ...
  return (
    <div className="min-h-screen bg-[#f9fbfb] font-sans" style={{ fontFamily: 'Inter, "Noto Sans", sans-serif' }}>
      <Header />
